...
This document describes the versioning and release process of Web-Push.
This document is a living document, contents will be updated according to each release.

## Releases

Web-Push releases will be versioned using dotted triples, similar to [Semantic Version](http://semver.org/).
